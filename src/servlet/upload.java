...
public class upload extends HttpServlet {
	...
	MultipartParser mp =new MultipartParser(request, 999999999);
		...
		String fullpath=editpath+"Transport\\WebContent\\Local\\";
	...
	//file encrypted and store into filepath1
             ...
             filepath1 = editpath + "\\Transport\\WebContent\\Encrypt\\"+filename;
              ...
              //file decrypted and store into filepath2
        		    ...
        		    filepath2 = editpath + "\\Transport\\WebContent\\Decrypt\\"+filename;
     ...
     filepath1 = editpath + "\\Transport\\WebContent\\Encrypt\\"+filename;
      ...
      //file decrypted and store into filepath2
			...
			upb.setDetail(paramValues.get(0).toString());
			System.out.println("Report Deatil "+paramValues.get(0).toString());
		
			upb.setEmail(paramValues.get(2).toString());
			System.out.println("Visitor name "+paramValues.get(0).toString());

			upb.setFkey(paramValues.get(4).toString());;
            System.out.println("File Key :"+paramValues.get(4).toString());  
          ...
          inter rr=new imple();
            int ms=rr.upload(upb);
         
            
            
            if(ms==1)
            {
            	response.sendRedirect("Reportsuccess.jsp");
